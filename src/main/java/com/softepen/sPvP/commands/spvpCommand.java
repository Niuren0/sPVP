...
import com.softepen.sPvP.commands.pvpCommands.Reload;
import com.softepen.sPvP.commands.pvpCommands.Settings;
...
public class spvpCommand implements CommandExecutor {
    ...
    public boolean onCommand(@NotNull CommandSender commandSender, @NotNull Command command, @NotNull String s, @NotNull String[] args) {
        if (args.length != 0) {
            if (Objects.equals(args[0], "reload") && commandSender.isOp()) {
